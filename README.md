...
* [`src/clj/datanl/`](src/clj/datanl/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/clj/datanl/`](src/clj/datanl/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/datanl/`](src/cljs/datanl/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/datanl/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/datanl/`](test/cljs/datanl/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `datanl` project root directory
...
in the [`src/clj/datanl/`](src/clj/datanl/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/datanl/config.cljs) defaults to `true` in
...
```clj
(ns datanl.example
  (:require [datanl.config :as config])
...
```sh
port=2000 java -jar target/datanl.jar
```
